...
import "../Login/Login.css"; // Reutiliza el diseño oscuro elegante del Login
        ...
        {mensajeExito ? (
          <div style={{ textAlign: "center", marginTop: "20px" }}>
            ...
            <p style={{ color: "#7A8E9F", fontSize: "13px", marginBottom: "24px" }}>
              💡 Revisa tu bandeja de entrada o carpeta de spam. (Si estás probando en desarrollo sin Gmail, mira la terminal del backend).
            </p>
